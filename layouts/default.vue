...
<div :style="{'background-color':backbg}">
 ...
 <NavShop  v-if="currentRouteName != 'salepage-id'  && (currentRouteName != 'buy-slug') && (currentRouteName != 'buy-thankyou')" />
 ...
 <div class="col-sm-12 col-md-12 col-lg-12 col-xl-9"> <Productbyshop  :product_by_shop="product_by_shop"  v-if="currentRouteName == 'index'"/></div>
   ...
   <LongFooter    v-if="currentRouteName != 'salepage-id'  && (currentRouteName != 'buy-slug') && (currentRouteName != 'buy-thankyou')" />
